...
// CLASS
public class Petugas_Vaksin extends User implements Informasi_Jadwal_Lokasi{
    // PROPERTY
    private long NIP;
    ...
    public void tambah_data(){
        System.out.println("~~~~~~ Petugas Vaksin Telah Berhasil Menambahkan Informasi Jadwal & Lokasi ! ~~~~~~");
    }
    
    @Override
    public void ubah_data(){
        System.out.println("~~~~~~~  Petugas Vaksin Telah Berhasil Mengubah Informasi Jadwal & Lokasi ! ~~~~~~~");
    }
    
    @Override
    public void hapus_data(){
        System.out.println("~~~~~~ Petugas Vaksin Telah Berhasil Menghapus Informasi Jadwal & Lokasi ! ~~~~~~~~");
    }
    
    static BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
    static ArrayList<Jadwal_Lokasi> jadwal_lokasi = new ArrayList<>();
    
    // IMPLEMENTASI METHOD DARI INTERFACE Informasi_Jadwal_Lokasi
    @Override
